...
import {Camera, ShuffleIcon, MapPinIcon,ShipWheelIcon, LoaderIcon } from 'lucide-react'
              ...
              <div className="form-control">
               ...
               <div className="form-control">
                ...
                <div className="relative">
                  <MapPinIcon className='absolute top-1/2 transform -translate-y-2 left-3 size-5 text-base-content opacity-70'/>
